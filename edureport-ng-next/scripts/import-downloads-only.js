...
const ADMIN_EMAIL = 'demo@reportsheet.com.ng';
...
async function main() {
  ...
  for (const file of files) {
    ...
    try {
      ...
      console.log(`   └─ Sending metadata and fileUrl to API...`);

      // Post to Import API
      const res = await fetch(`${API_BASE_URL}/api/ai/exam/bulk-import-document`, {
        method: 'POST',
        headers: {
